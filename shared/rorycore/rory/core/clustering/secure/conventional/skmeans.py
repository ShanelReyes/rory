...
class SKMeans(ConventionalClustering):
    ...
    def execute_encrypted_phase(
        ...
        **kwargs,
        ...
        Delegates to the Liu-based encrypted-phase utility, which uses
        symmetric homomorphic encryption for the KMeans iterative steps.
    ...
    def execute_plaintext_phase(
        ...
        **kwargs,
        ...
        Matrix in plaintext, preparing it for the next iteration.
    ...
    def compute_centroid_shift(
        ...
        **kwargs,
        ...
        Delegates to the Liu-based utility for computing the encrypted
    ...
    def fit(
        ...
        """Run the iterative Liu-based secure KMeans clustering.

        Delegates to the conventional iterative fitting utility, which
        alternates between encrypted and plaintext phases until convergence
