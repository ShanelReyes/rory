...
RORY_MANAGER_LOG_INTERVAL              = int(os.environ.get("RORY_MANAGER_LOG_INTERVAL",24))
RORY_MANAGER_LOG_WHEN                  = os.environ.get("RORY_MANAGER_LOG_WHEN","h")
RORY_MANAGER_LOG_JSON_FORMATTER_INDENT = os.environ.get("RORY_MANAGER_LOG_JSON_FORMATTER_INDENT",4)
RORY_MANAGER_LOG_DISABLED              = bool(int(os.environ.get("RORY_MANAGER_LOG_DISABLED","1")))
RORY_MANAGER_LOG_ERROR_TO_FILE         = bool(int(os.environ.get("RORY_MANAGER_LOG_ERROR_TO_FILE","1")))
RORY_MANAGER_LOG_FILE_HANDLER_LEVEL    = int(os.environ.get("RORY_MANAGER_LOG_FILE_HANDLER_LEVEL",logging.INFO))
RORY_MANAGER_LOG_LEVEL                 = int(os.environ.get("RORY_MANAGER_LOG_LEVEL",logging.DEBUG))
RORY_MANAGER_LOG_TO_FILE               = bool(int(os.environ.get("RORY_MANAGER_LOG_TO_FILE","1")))
RORY_MANAGER_LOG_USE_RICH              = bool( int(os.environ.get("RORY_MANAGER_LOG_USE_RICH","0") ) )


LOGGER = Log(
    name                   = NODE_ID,
    path                   = LOG_PATH,
    interval               = RORY_MANAGER_LOG_INTERVAL,
    when                   = RORY_MANAGER_LOG_WHEN,
    console_formatter      = JsonFormatter(indent=int(RORY_MANAGER_LOG_JSON_FORMATTER_INDENT) if RORY_MANAGER_LOG_JSON_FORMATTER_INDENT is not None else None),
    console_handler_level  = RORY_MANAGER_LOG_LEVEL,
    disabled               = RORY_MANAGER_LOG_DISABLED,
    error_log              = RORY_MANAGER_LOG_ERROR_TO_FILE,
    file_handler_level     = RORY_MANAGER_LOG_FILE_HANDLER_LEVEL,
    log_level              = RORY_MANAGER_LOG_LEVEL,
    to_file                = RORY_MANAGER_LOG_TO_FILE,
    use_rich               = RORY_MANAGER_LOG_USE_RICH
)
# LOGGER = Log(
#     name                   = NODE_ID,
#     path                   = LOG_PATH,
