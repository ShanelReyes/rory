...
class Nnc:
	...
	@staticmethod
	def run(distance_matrix:Any, threshold:float):
		startTime                 = time()
		...
		label_vector = Nnc.get_labelvector( #gets final label vector
			c_indexes = c_indexes,
